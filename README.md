...
<img alt="Diagram showing the channel composition process" width="75%" src="./docs/channel-composition.png">
...
<img alt="Diagram showing the upload process" width="75%" src="./docs/upload.png">
